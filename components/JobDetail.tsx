    ...
    data && (
      <div className="flex flex-col gap-5 my-5 mx-5 ">
        <header className="header-custom flex justify-between">
          ...
          <span className="flex gap-2 ">
            <JobInfo
              ...
              icon={
                <CalendarDaysIcon className="stroke-primary-accent stroke-1" />
              }
              className="justify-end  "
            />
            <Badge
              className="w-32 justify-center self-start"
              variant={data.status}
            >
        ...
        <main className="main-custom">
          ...
          <section className="pb-10">
            <span className="flex gap-2 pb-2">
              <IconFileInfo stroke={1} className="stroke-primary-accent" /> Info
              del puesto:
            </span>
        ...
        <footer className="flex gap-4 justify-end border-t-2 border-primary-accent pt-5">
          <Button
            asChild
            className={
              'border-2 border-primary-accent bg-transparent rounded-sm'
            }
            variant="outline"
          >
